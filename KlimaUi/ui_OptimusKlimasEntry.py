...
class myThreadSim(threading.Thread):
    ...
    def run(self):
        ...
        modelnamesea = 'kalaSST104.h5'  # 'kalaSST100.h5'
        newsea = True
        # use different model if co2 or ch4 increase exceeds 200 %
        # (try ... except needed because if ssp scenario is used ghgs does not necessarily need to be given)
        try:
            if co2 > 200:
