...
def displayheatmap_diff():
    # displays heatmap with calculated difference in temperature between 2100 and 2014
...
class threaddiffmap(threading.Thread):
    ...
    def run(self):
        ...
        for i in range(u):
            if seause:
                diff[i] = predf[0][99, i] - predf[0][0, i]
            else:
                try:
    ...
    def run(self):
        while(True):
            ...
            if ui.checkBox_ssp2.isChecked() or ui.checkBox_ssp1.isChecked() or ui.checkBox_ssp19.isChecked():
                ...
                ui.checkBox_amazonas.setCheckable(False)
                ui.checkBox_tippingpoints.setCheckable(False)
                ui.CheckBox_wais.setCheckable(False)
            if ui.checkBox_ssp3.isChecked() or ui.checkBox_ssp5.isChecked():
                ...
                ui.checkBox_amazonas.setCheckable(True)
                ui.checkBox_tippingpoints.setCheckable(True)
                ui.CheckBox_wais.setCheckable(True)
